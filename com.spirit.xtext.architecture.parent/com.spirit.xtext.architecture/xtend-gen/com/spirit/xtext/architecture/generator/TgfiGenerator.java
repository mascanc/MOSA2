 ...
 */
package com.spirit.xtext.architecture.generator;
...
public class TgfiGenerator extends AbstractGenerator {
    ...
    for (final MainTgf e : _filter) {
      {
        ...
        if (_tripleNotEquals) {
          ...
          InputOutput.<String>println(((("Package generated is not null, so I am generating " + this.packageGenerated) + " in directory ") + this.packageDirectory));
        } else {
  ...
  public CharSequence compileLIST(final MainTgf e) {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("import com.spirit.togaf.bb.ABB;");
    _builder.newLine();
    _builder.newLine();
  ...
  public CharSequence compileSAT(final MainTgf e) {
    ...
    _builder.append("import com.spirit.togaf.bb.SAT;");
    _builder.newLine();
    _builder.append("import com.spirit.togaf.bb.dependencies.TFRule;");
    _builder.newLine();
    _builder.newLine();
  ...
  public CharSequence compile(final Profile e) {
    ...
    _builder.append("import com.spirit.togaf.bb.ABB;");
    _builder.newLine();
    _builder.append("import com.spirit.togaf.bb.dependencies.Actor;");
    _builder.newLine();
    _builder.append("import com.spirit.togaf.bb.dependencies.Domain;");
    _builder.newLine();
    _builder.append("import com.spirit.togaf.bb.dependencies.QualityAttribute;");
    _builder.newLine();
    _builder.append("import com.spirit.togaf.bb.dependencies.Transaction;");
    _builder.newLine();
    _builder.append("        ");
    _builder.newLine();
    _builder.append("public class ");
