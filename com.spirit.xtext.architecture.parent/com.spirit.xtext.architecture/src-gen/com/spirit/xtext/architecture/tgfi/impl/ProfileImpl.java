 ...
 *   <li>{@link com.spirit.xtext.architecture.tgfi.impl.ProfileImpl#getSecre <em>Secre</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProfileImpl extends MinimalEObjectImpl.Container implements Profile
{
  ...
  public EList<SecRequirements> getSecre()
  {
    if (secre == null)
    {
      secre = new EObjectContainmentEList<SecRequirements>(SecRequirements.class, this, TgfiPackage.PROFILE__SECRE);
    }
    return secre;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TgfiPackage.PROFILE__SECRE:
