...
public interface TgfiPackage extends EPackage
{
  ...
  /**
   * The meta object id for the '{@link com.spirit.xtext.architecture.tgfi.impl.SecRequirementsImpl <em>Sec Requirements</em>}' class.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @see com.spirit.xtext.architecture.tgfi.impl.SecRequirementsImpl
   * @see com.spirit.xtext.architecture.tgfi.impl.TgfiPackageImpl#getSecRequirements()
   * @generated
   */
   ...
   * @ordered
   */
  int SEC_REQUIREMENTS__SECRE_GOAL = 0;

  /**
   * The feature id for the '<em><b>Secre Level</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int SEC_REQUIREMENTS__SECRE_LEVEL = 1;
   ...
   * @ordered
   */
  int SEC_REQUIREMENTS__SECRE_LOCATION = 2;
   ...
   * @ordered
   */
  int SEC_REQUIREMENTS__SECRE_STATE = 3;

  /**
   * The feature id for the '<em><b>Secre Descr</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int SEC_REQUIREMENTS__SECRE_DESCR = 4;
   ...
   * @ordered
   */
  int SEC_REQUIREMENTS__SECRE_CATEGORY = 5;
   ...
   * @ordered
   */
  int SEC_REQUIREMENTS_FEATURE_COUNT = 6;
  ...
  /**
   * Returns the meta object for the containment reference list '{@link com.spirit.xtext.architecture.tgfi.Profile#getSecre <em>Secre</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the containment reference list '<em>Secre</em>'.
   * @see com.spirit.xtext.architecture.tgfi.Profile#getSecre()
   * @see #getProfile()
   * @generated
   */
  ...
  /**
   * Returns the meta object for class '{@link com.spirit.xtext.architecture.tgfi.SecRequirements <em>Sec Requirements</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for class '<em>Sec Requirements</em>'.
   * @see com.spirit.xtext.architecture.tgfi.SecRequirements
   * @generated
   */
  EClass getSecRequirements();

  /**
   * Returns the meta object for the attribute '{@link com.spirit.xtext.architecture.tgfi.SecRequirements#getSecreGoal <em>Secre Goal</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Secre Goal</em>'.
   * @see com.spirit.xtext.architecture.tgfi.SecRequirements#getSecreGoal()
  ...
  /**
   * Returns the meta object for the attribute '{@link com.spirit.xtext.architecture.tgfi.SecRequirements#getSecreLevel <em>Secre Level</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Secre Level</em>'.
   * @see com.spirit.xtext.architecture.tgfi.SecRequirements#getSecreLevel()
   * @see #getSecRequirements()
   * @generated
   */
  EAttribute getSecRequirements_SecreLevel();

  /**
   * Returns the meta object for the attribute '{@link com.spirit.xtext.architecture.tgfi.SecRequirements#getSecreLocation <em>Secre Location</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Secre Location</em>'.
   * @see com.spirit.xtext.architecture.tgfi.SecRequirements#getSecreLocation()
   * @see #getSecRequirements()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link com.spirit.xtext.architecture.tgfi.SecRequirements#getSecreState <em>Secre State</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Secre State</em>'.
   * @see com.spirit.xtext.architecture.tgfi.SecRequirements#getSecreState()
   * @see #getSecRequirements()
   * @generated
   */
  ...
  /**
   * Returns the meta object for the attribute '{@link com.spirit.xtext.architecture.tgfi.SecRequirements#getSecreDescr <em>Secre Descr</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Secre Descr</em>'.
   * @see com.spirit.xtext.architecture.tgfi.SecRequirements#getSecreDescr()
   * @see #getSecRequirements()
   * @generated
   */
  EAttribute getSecRequirements_SecreDescr();

  /**
   * Returns the meta object for the attribute '{@link com.spirit.xtext.architecture.tgfi.SecRequirements#getSecreCategory <em>Secre Category</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Secre Category</em>'.
   * @see com.spirit.xtext.architecture.tgfi.SecRequirements#getSecreCategory()
   * @see #getSecRequirements()
   * @generated
   */
  ...
  interface Literals
  {
    ...
    /**
     * The meta object literal for the '{@link com.spirit.xtext.architecture.tgfi.impl.SecRequirementsImpl <em>Sec Requirements</em>}' class.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @see com.spirit.xtext.architecture.tgfi.impl.SecRequirementsImpl
     * @see com.spirit.xtext.architecture.tgfi.impl.TgfiPackageImpl#getSecRequirements()
    ...
    /**
     * The meta object literal for the '<em><b>Secre Level</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute SEC_REQUIREMENTS__SECRE_LEVEL = eINSTANCE.getSecRequirements_SecreLevel();
    ...
    /**
     * The meta object literal for the '<em><b>Secre Descr</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute SEC_REQUIREMENTS__SECRE_DESCR = eINSTANCE.getSecRequirements_SecreDescr();
