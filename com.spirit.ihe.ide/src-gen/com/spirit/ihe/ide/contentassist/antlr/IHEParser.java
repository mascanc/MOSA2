...
public class IHEParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, IHEGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSecRequirementsAccess().getSecreGoalAssignment_2_2(), "rule__SecRequirements__SecreGoalAssignment_2_2");
			builder.put(grammarAccess.getSecRequirementsAccess().getSecreLevelAssignment_3_2(), "rule__SecRequirements__SecreLevelAssignment_3_2");
			...
			builder.put(grammarAccess.getSecRequirementsAccess().getSecreDescAssignment_6_2(), "rule__SecRequirements__SecreDescAssignment_6_2");
			builder.put(grammarAccess.getSecRequirementsAccess().getSecreCategoryAssignment_7_2(), "rule__SecRequirements__SecreCategoryAssignment_7_2");
