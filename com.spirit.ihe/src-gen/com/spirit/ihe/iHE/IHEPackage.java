...
public interface IHEPackage extends EPackage
{
   ...
   * @ordered
   */
  int SEC_REQUIREMENTS__SECRE_GOAL = 1;
   ...
   * @ordered
   */
  int SEC_REQUIREMENTS__SECRE_LEVEL = 2;
   ...
   * @ordered
   */
  int SEC_REQUIREMENTS__SECRE_DESC = 5;
   ...
   * @ordered
   */
  int SEC_REQUIREMENTS__SECRE_CATEGORY = 6;
   ...
   * @ordered
   */
  int SEC_REQUIREMENTS_FEATURE_COUNT = 7;
  ...
  /**
   * Returns the meta object for the attribute '{@link com.spirit.ihe.iHE.SecRequirements#getSecreLevel <em>Secre Level</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Secre Level</em>'.
   * @see com.spirit.ihe.iHE.SecRequirements#getSecreLevel()
   * @see #getSecRequirements()
   * @generated
   */
