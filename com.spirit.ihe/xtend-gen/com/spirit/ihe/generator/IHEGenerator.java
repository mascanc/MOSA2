...
public class IHEGenerator extends AbstractGenerator {
  ...
  public CharSequence compile(final Profile e) {
    ...
    _builder.newLine();
    _builder.append("import com.spirit.togaf.bb.dependencies.SecurityRequirement;");
    _builder.newLine();
    _builder.append("        ");
    _builder.newLine();
    _builder.append("public class ");
    ...
    _builder.newLine();
    {
      ...
      for(final SecRequirements sre : _secre) {
        ...
        _builder.append("        \t\t");
        _builder.append("\t");
        _builder.append("private String level = \"");
        String _secreLevel = sre.getSecreLevel();
        _builder.append(_secreLevel, "        \t\t\t");
        _builder.append("\";");
        _builder.newLineIfNotEmpty();
        _builder.append("        \t\t");
        _builder.append("\t");
        ...
        _builder.append("        \t\t");
        _builder.append("\t");
        _builder.append("public String getLevel() {");
        _builder.newLine();
        _builder.append("        \t\t");
        _builder.append("\t\t");
        _builder.append("return this.level;\t");
        _builder.newLine();
        _builder.append("        \t\t");
        _builder.append("\t");
        _builder.append("}");
